 ...
 */
{
    "circles": {
        ...
        "view": [
            ...
            { "enabled":  true, "distance": 445,                  "scale": 1, "thickness": 0.5,  "alpha": 60, "color": "0xb9c42f" },
            // Additional circles:
            // Дополнительные круги:
            { "enabled":  true, "distance": 50,                   "scale": 1, "thickness": 0.5, "alpha": 80, "color": "0xef454a" },
            { "enabled":  true, "distance": 720,                  "scale": 1, "thickness": 0.5, "alpha": 60, "color": "0x0090a8" },
            { "enabled":  true, "distance": "blindarea_standing", "scale": 1, "thickness": 1.0, "alpha": 80, "color": "0xffd700" },
            { "enabled":  true, "distance": "blindarea_motion",   "scale": 1, "thickness": 1.0, "alpha": 80, "color": "0xf15a22" }
            // { "enabled":  true, "distance": "dynamic",   "scale": 1, "thickness": 1.0, "alpha": 80, "color": "0x3EB5F1" }
        ],
        ...
        "artillery": { "enabled": true, "alpha": 80, "color": "0xa09bd8", "thickness": 0.5 },
        // Maximum range of shooting for machine gun
        // Максимальная дальность полета снаряда для пулеметных танков
        "shell":     { "enabled": true, "alpha": 80, "color": "0xa09bd8", "thickness": 0.5 },

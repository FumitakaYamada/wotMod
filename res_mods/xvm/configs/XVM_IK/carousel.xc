 ...
 */
{
  "carousel": {
    ...
    "extraFields": [
      // Sign of mastery.
      // Знак мастерства.
      { "x": -1, "y": 60, "format": "<img src='img://gui/maps/icons/library/proficiency/class_icons_{{v.mastery}}.png' width='23' height='23'>" },
      // Battle Tier. referenced Dumadidak [EU]
      // http://www.koreanrandom.com/forum/topic/19250-xvm-carousel-how-chanege-macro-into-the-img/
      {
        "x": 0,
        "y": 15,
        "align": "left",
        "format": "<font size='14' color='#7d7d75'>({{v.battletiermin}}-{{v.battletiermax}})</font>",
        "shadow": 
        {

 ...
 */
{
  "labels": {
      ...
      "units": {
        ...
        "format": {
          // Союзник.
          "ally":           "<span class='mm_a'>{{vehicle}}{{turret}}{{marksOnGun}}</span>",
          // Тимкиллер.
          "teamkiller":     "<span class='mm_t'>{{vehicle}}{{turret}}{{marksOnGun}}</span>",
          // Враг.
          "enemy":          "<span class='mm_e'>{{vehicle}}{{turret}}{{marksOnGun}}</span>",
          // Взводный.
          "squad":          "<textformat leading='-2'><span class='mm_s'><i>{{nick%.5s}}</i>\n{{vehicle}}{{turret}}{{marksOnGun}}</span><textformat>",
          ...
          "lostally":       "<span class='mm_dot'>{{vehicle-class}}</span><span class='mm_la'><i>{{vehicle}}{{turret}}{{marksOnGun}}</i></span>",
          // Out of radio range teamkiller
          // Тимкиллер, с которым потеряна связь
          "lostteamkiller": "<span class='mm_dot'>{{vehicle-class}}</span><span class='mm_lt'><i>{{vehicle}}{{turret}}{{marksOnGun}}</i></span>",
          // Lost enemy units.
          // Противник, пропавший из засвета
          "lost":           "<span class='mm_dot'>{{vehicle-class}}</span><span class='mm_l'><i>{{vehicle}}{{turret}}{{marksOnGun}}</i></span>",
        ...
        "css": {
          ...
          "enemy":          ${"z_stats_RB.xc":"minimapLabelsAlt.css.enemy"},
          ...
          "lost":           ${"z_stats_RB.xc":"minimapLabelsAlt.css.lost"},

  ...
  "ally": {
    ...
    "textFields": [
      ...
      // Текстовое поле с именем игрока.
      {
        ...
        "format": "{{nick}}{{turret}}{{marksOnGun}}"            // формат текста. См. описание макросов в readme-ru.txt
      },
      ...
      {
        "name": "Stats",
        "visible": ${"z_stats_RB.xc":"Extended.visible"},
        "x": 0,
        "y": -46,
        "alpha": 100,
        "color": "null",
        ...
        "format": ${"z_stats_RB.xc":"Extended.format"}
      }
    ]
  },

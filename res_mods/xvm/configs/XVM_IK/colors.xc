 ...
 */
{
  ...
  "def": {
    ...
    "en": ${"z_stats_RB.xc":"colors.en"},
    "pl": "0xFFDD33", // player     / игрок
    // Dynamic color by various statistical parameters.
    // Динамический цвет по различным статистическим показателям.
    "colorRatingIK": {
      "below_average": "0xFCFCFC", // below average
      "above_average": "0xCCB800", // above average
      "fine":          "0x849B24", // fine
      "good":          "0x4D7326", // good
      "very_good":     "0x4F8C92", // very good
      "great":         "0x3972C6", // great
      "excellent":     "0x6846A5", // excellent
      "unicum":        "0xA757A8", // unicum
      "super_unicum":  "0xA09BD8"  // super unicum
    },
    "colorRating": {
      ...
      "very_bad":       "0xb22d35",   // very bad
      "bad":            "0xef454a",   // bad
      "below_average" : "0xf15a22",   // below average
      "normal":         "0xffd700",   // normal,average
      "good":           "0xb9c42f",   // good
      "very_good":      "0x49a581",   // very good
      "great":          "0x0090a8",   // great
      "unique":         "0xa757a8",   // unique
      "super_unicum":   "0xa09bd8"    // super unicum
    ...
    "colorHP": {
      ...
      "above_average":    "0xFCFCFC",   // above-average  / выше среднего
      "no_damage":        "0xCCFF00"    // no-damage  / выше среднего
    }
  },
  "colors": {
    // System colors.
    ...
    "system": {
      ...
      "enemy_dead":          ${"z_stats_RB.xc":"colors.enemy_dead"},
      "enemy_blowedup":      ${"z_stats_RB.xc":"colors.enemy_blowedup"},
      "ally_base":           ${"def.al"},
      "enemy_base":          ${"def.en"}
    },
    ...
    "hp_ratio": [
      ...
      { "value": 100, "color": ${"def.colorHP.above_average"} },      // Цвет для остальных значений
      { "value": 101, "color": ${"def.colorHP.no_damage"} }           // Цвет для остальных значений
    ],
    ...
    "eff": [
      ...
      { "value":  549.5, "color": ${"def.colorRating.very_bad"      } },   //    0 -  549 - very bad
      { "value":  629.5, "color": ${"def.colorRating.bad"           } },   //  550 -  629 - bad
      { "value":  859.5, "color": ${"def.colorRating.below_average" } },   //  630 -  859 - below average
      { "value": 1139.5, "color": ${"def.colorRating.normal"        } },   //  860 - 1139 - average
      { "value": 1459.5, "color": ${"def.colorRating.good"          } },   // 1140 - 1459 - good
      { "value": 1549.5, "color": ${"def.colorRating.very_good"     } },   // 1460 - 1549 - very good
      { "value": 1734.5, "color": ${"def.colorRating.great"         } },   // 1550 - 1734 - excellent
      { "value": 1899.5, "color": ${"def.colorRating.unique"        } },   // 1735 - 1899 - unicum
      { "value": 9999,   "color": ${"def.colorRating.super_unicum"  } }    // 1900 - *    - super unicum
    ],
    ...
    "wn6": [
      ...
      { "value":  499.5, "color": ${"def.colorRating.very_bad"      } },   //    0 -  499 - very bad
      { "value":  749.5, "color": ${"def.colorRating.bad"           } },   //  500 -  749 - bad
      { "value":  899.5, "color": ${"def.colorRating.below_average" } },   //  750 -  899 - below average
      { "value": 1099.5, "color": ${"def.colorRating.normal"        } },   //  900 - 1099 - average
      { "value": 1349.5, "color": ${"def.colorRating.good"          } },   // 1100 - 1349 - good
      { "value": 1599.5, "color": ${"def.colorRating.very_good"     } },   // 1350 - 1599 - very good
      { "value": 1899.5, "color": ${"def.colorRating.great"         } },   // 1600 - 1899 - excellent
      { "value": 2099.5, "color": ${"def.colorRating.unique"        } },   // 1900 - 2099 - unicum
      { "value": 9999,   "color": ${"def.colorRating.super_unicum"  } }    // 2100 - *    - super unicum
    ],
    ...
    "wn8": [
      ...
      { "value":  819.5, "color": ${"def.colorRatingIK.below_average" } }, //    0 -  819
      { "value":  989.5, "color": ${"def.colorRatingIK.above_average" } }, //  820 -  989
      { "value": 1369.5, "color": ${"def.colorRatingIK.fine"          } }, //  990 - 1369
      { "value": 1609.5, "color": ${"def.colorRatingIK.good"          } }, // 1370 - 1609
      { "value": 2019.5, "color": ${"def.colorRatingIK.very_good"     } }, // 1610 - 2019
      { "value": 2229.5, "color": ${"def.colorRatingIK.great"         } }, // 2020 - 2229
      { "value": 2619.5, "color": ${"def.colorRatingIK.excellent"     } }, // 2230 - 2619
      { "value": 3079.5, "color": ${"def.colorRatingIK.unicum"        } }, // 2620 - 3079
      { "value": 9999,   "color": ${"def.colorRatingIK.super_unicum"  } }  // 3080 - ****
    ],
    ...
    "wgr": [
      ...
      { "value":  4184.5, "color": ${"def.colorRatingIK.below_average" } }, //     0 -  4184
      { "value":  4869.5, "color": ${"def.colorRatingIK.above_average" } }, //  4185 -  4869
      { "value":  6339.5, "color": ${"def.colorRatingIK.fine"          } }, //  4870 -  6339
      { "value":  7214.5, "color": ${"def.colorRatingIK.good"          } }, //  6340 -  7214
      { "value":  8524.5, "color": ${"def.colorRatingIK.very_good"     } }, //  7215 -  8524
      { "value":  9059.5, "color": ${"def.colorRatingIK.great"         } }, //  8525 -  9059
      { "value":  9929.5, "color": ${"def.colorRatingIK.excellent"     } }, //  9060 -  9929
      { "value": 10579.5, "color": ${"def.colorRatingIK.unicum"        } }, //  9930 - 10579
      { "value": 99999,   "color": ${"def.colorRatingIK.super_unicum"  } }  // 10580 - *****
    ],
    ...
    "rating": [
      ...
      { "value":  48.5, "color": ${"def.colorRatingIK.below_average" } }, //  0   -  48.4
      { "value":  49.5, "color": ${"def.colorRatingIK.above_average" } }, // 48.5 -  49.4
      { "value":  51.5, "color": ${"def.colorRatingIK.fine"          } }, // 49.5 -  51.4
      { "value":  53.5, "color": ${"def.colorRatingIK.good"          } }, // 51.5 -  53.4
      { "value":  56.5, "color": ${"def.colorRatingIK.very_good"     } }, // 53.5 -  56.4
      { "value":  59.5, "color": ${"def.colorRatingIK.great"         } }, // 56.5 -  59.4
      { "value":  64.5, "color": ${"def.colorRatingIK.excellent"     } }, // 59.5 -  64.4
      { "value":  69.5, "color": ${"def.colorRatingIK.unicum"        } }, // 64.5 -  69.4
      { "value": 101,   "color": ${"def.colorRatingIK.super_unicum"  } }  // 69.5 - 100
    ],
    ...
    "kb": [
      ...
      { "value":  0.75, "color": ${"def.colorRatingIK.below_average" } }, //     0 -   749
      { "value":  1,    "color": ${"def.colorRatingIK.above_average" } }, //   750 -   999
      { "value":  1.5,  "color": ${"def.colorRatingIK.fine"          } }, //  1000 -  1499
      { "value":  2.5,  "color": ${"def.colorRatingIK.good"          } }, //  1500 -  2499
      { "value":  4.5,  "color": ${"def.colorRatingIK.very_good"     } }, //  2500 -  4499
      { "value":  7.5,  "color": ${"def.colorRatingIK.great"         } }, //  4500 -  7499
      { "value":  9.5,  "color": ${"def.colorRatingIK.excellent"     } }, //  7500 -  9499
      { "value": 19.5,  "color": ${"def.colorRatingIK.unicum"        } }, //  9500 - 19499
      { "value": 999,   "color": ${"def.colorRatingIK.super_unicum"  } }  // 19500 - *****
    ],
    ...
    "t_battles": [
      ...
      { "value":    75, "color": ${"def.colorRatingIK.below_average" } }, //    0 -   74
      { "value":   100, "color": ${"def.colorRatingIK.above_average" } }, //   75 -   99
      { "value":   150, "color": ${"def.colorRatingIK.fine"          } }, //  100 -  149
      { "value":   250, "color": ${"def.colorRatingIK.good"          } }, //  150 -  249
      { "value":   450, "color": ${"def.colorRatingIK.very_good"     } }, //  250 -  449
      { "value":   750, "color": ${"def.colorRatingIK.great"         } }, //  450 -  749
      { "value":   950, "color": ${"def.colorRatingIK.excellent"     } }, //  750 -  949
      { "value":  1950, "color": ${"def.colorRatingIK.unicum"        } }, //  950 - 1949
      { "value": 99999, "color": ${"def.colorRatingIK.super_unicum"  } }  // 1950 - ****
    ],

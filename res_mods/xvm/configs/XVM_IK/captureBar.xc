 ...
 */
{
  "captureBar": {
    ...
    "enemy": { // Вражеской.
      ...
      "primaryTitleFormat":   "<font size='15' color='#FCFCFC'>{{l10n:enemyBaseCapture}} {{extra}}</font>",
      // Lower textfield.
    ...
    "ally": { // Союзников.
      "primaryTitleFormat":   "<font size='15' color='#FCFCFC'>{{l10n:allyBaseCapture}} {{extra}}</font>",
      "secondaryTitleFormat": "<font size='15' color='#FCFCFC'>{{points}}</font>",

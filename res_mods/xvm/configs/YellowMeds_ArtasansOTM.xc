{
  ...
  "definition": {
    "author": "Artasan",
    "date": "23.06.2014",
    "description": "Dealt Damage Panel (yellow meds, artasan's otm)",
    "gameVersion": "0.9.1",
    "modMinVersion": "5.2.1",
    "url": "http://www.curse.com/users/Artasan/"
  },
  "rating": {
    "enableCompanyStatistics": false,
    "enableStatisticsLog": false,
    "enableUserInfoStatistics": false,
  ...
  "login": {
    ...
    "pingServers": {
      ...
      "fontStyle": {
        "bold": false,
        "color": { "bad": "0x660000", "good": "0xFF9900", "great": "0xFFFF00", "poor": "0xFF0000" },
        "italic": false,
        "name": "$FieldFont",
        "size": 12
      },
  ...
  "squad": { "enabled": false, "leftLvlBorder": "", "rightLvlBorder": "", "romanNumbers": true, "showClan": false },
  "userInfo": {
    "defaultFilterValue": "",
    "filterFocused": true,
  ...
  "hotkeys": { "minimapZoom": { "enabled": false, "keyCode": 17, "onHold": false } },
  "hitLog": {
    "visible": true,
    "x": 270,
    "blowupMarker": "<font face='Wingdings'>M</font>",
    "deadMarker": "<font face='Wingdings'>N</font>",
    "defaultHeader": "<font color='#FFFFFF'>{{l10n:Total damage w/o blind shots.}}</font> ",
    "direction": "down",
    "formatHeader": "<font color='#FFFFFF'>{{l10n:Total damage}}: </font><font color='#FF8800'><b>{{dmg-total}}</b></font>  <font color='#FFFFFF'>{{l10n:Damage hits}}: </font><font color='#FF8800'><b>{{n}}</b></font>  <font color='#FFFFFF'>{{l10n:Last hit}}: </font><font color='#FF8800'><b>{{dmg}}</b> {{dead}}</font>",
    "formatHistory": "<textformat leading='-4' tabstops='[20,50,90,160]'><font size='12'>×{{n-player}}:</font><tab>{{dmg-player}}<tab>| <font color='{{c:dmg-kind}}'>-{{dmg}}</font><tab> <font color='#FFFFFF'>({{dmg-kind}})</font><tab>| <font color='{{c:vtype}}'>{{vehicle}} {{dead}}</font></textformat>",
    ...
    "ally": {
      "alive": {
        "normal": {
          ...
          "damageText": {
            ...
            "color": null,
            "damageMessage": "-{{dmg}}",
            "font": { "align": "center", "bold": true, "italic": false, "name": "$FieldFont", "size": 22 },
            "maxRange": 100,
          ...
          "healthBar": {
            "alpha": 100,
            "border": { "alpha": 66, "color": "0x000000", "size": 0 },
            "color": null,
          ...
          "levelIcon": { "alpha": 100, "visible": true, "x": 0, "y": -63 },
          "textFields": [
            {
              "alpha": 100,
              "color": null,
      ...
      "dead": {
        "normal": {
          ...
          "clanIcon": { "alpha": 100, "h": 16, "visible": false, "w": 16, "x": 0, "y": -67 },
          "contourIcon": { "alpha": 100, "amount": 0, "color": null, "visible": false, "x": 6, "y": 0 },
          "damageText": {
            "alpha": 100,
            "blowupMessage": "{{l10n:blownUp}}",
            "color": null,
          ...
          "levelIcon": { "alpha": 100, "visible": false, "x": 0, "y": -6 },
          "textFields": [
    ...
    "enemy": {
      ...
      "dead": {
        "normal": {
          "actionMarker": { "alpha": 100, "visible": false, "x": 0, "y": -67 },
          "clanIcon": { "alpha": 100, "h": 16, "visible": false, "w": 16, "x": 0, "y": -67 },
          "contourIcon": { "alpha": 100, "amount": 0, "color": null, "visible": true, "x": 6, "y": 0 },
          "damageText": {
            "alpha": 100,
            "blowupMessage": "{{l10n:blownUp}}",
            "color": null,
          ...
          "levelIcon": { "alpha": 100, "visible": true, "x": 0, "y": -6 },
          "textFields": [
  ...
  "colors": {
    ...
    "damage": {
      ...
      "player_ally_blowup": "0x00CC00",
      "player_ally_hit": "0x00CC00",
      "player_ally_kill": "0x00CC00",
      ...
      "player_squadman_blowup": "0x9933FF",
      "player_squadman_hit": "0x9933FF",
      "player_squadman_kill": "0x9933FF",
      ...
      "squadman_enemy_blowup": "0x9933FF",
      "squadman_enemy_hit": "0x9933FF",
      "squadman_enemy_kill": "0x9933FF",
    ...
    "eff": [
      ...
      { "value": 1145, "color": "0xF8F400" },
      { "value": 1475, "color": "0x60FF00" },
      { "value": 1775, "color": "0x02C9B3" },

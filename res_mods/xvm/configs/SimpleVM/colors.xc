 ...
 */
{
  ...
  "colors": {
    ...
    "x": [
      ...
      { "value": 56,  "color": ${"def.colorRating.normal"   } },   // 33.5 - 52.5 - normal     (better then 60% of players)
      ...
      { "value": 97, "color": ${"def.colorRating.unique"    } },   // 92.5 - 96.5 - unique     (better then 99.9% of players)
      { "value": 999, "color": ${"def.colorRating.godlike"  } }    // 97.5 - XX   - godlike
    ],
    ...
    "wn8": [
      ...
      { "value": 2965, "color": ${"def.colorRating.unique"   } },  // 2525 - 2964 - unique     (better then 99.9% of players)
      { "value": 9999, "color": ${"def.colorRating.godlike"  } }   // 2965 - *    - godlike
    ],
    ...
    "rating": [
      { "value": 46,  "color": ${"def.colorRating.moron"    } },   //  0   - 45.5 - very bad
      { "value": 49,  "color": ${"def.colorRating.bad"      } },   // 46.5 - 48.5 - bad
      { "value": 51,  "color": ${"def.colorRating.normal"   } },   // 48.5 - 51.5 - normal
      { "value": 55,  "color": ${"def.colorRating.good"     } },   // 51.5 - 54.5 - good
      { "value": 61,  "color": ${"def.colorRating.very_good"} },   // 54.5 - 60.5 - very good
      { "value": 65,  "color": ${"def.colorRating.unique"   } },   // 60.5 - 64.5 - unique
      { "value": 101, "color": ${"def.colorRating.godlike"  } }    // 60.5 - 100  - godlike
    ],
    // Dynamic color by kilo-battles (only with xvm-stat).
    // Динамический цвет по количеству кило-боев (только с xvm-stat).
    "kb": [
      { "value": 1,   "color": ${"def.colorRating.moron"    } },
      { "value": 3,   "color": ${"def.colorRating.bad"      } },
      { "value": 7,   "color": ${"def.colorRating.normal"   } },
      { "value": 9,   "color": ${"def.colorRating.good"     } },
      { "value": 14,  "color": ${"def.colorRating.very_good"} },
      { "value": 20,  "color": ${"def.colorRating.unique"   } },
      { "value": 999,  "color": ${"def.colorRating.godlike" } }
    ],
    ...
    "t_battles": [
      { "value": 50,    "color": ${"def.colorRating.moron"    } }, //    0 - 50
      { "value": 150,   "color": ${"def.colorRating.bad"      } }, //  100 - 149
      { "value": 500,   "color": ${"def.colorRating.normal"   } }, //  250 - 499
      { "value": 1000,  "color": ${"def.colorRating.good"     } }, //  500 - 999
      { "value": 1700,  "color": ${"def.colorRating.very_good"} }, // 1000 - 1699
      { "value": 2500,  "color": ${"def.colorRating.unique"   } }, // 1500 - 2499
      { "value": 99999, "color": ${"def.colorRating.godlike"  } }  // 2500 - *
    ],

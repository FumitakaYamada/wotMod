...
-----------------------------------------------------------
  ...
  Используемые макросы:
    В ушах, на экране загрузки боя, в окне статистики боя по Tab и в маркерах над танком:
      ...
      {{squad}}       - значение 'sq' для своего взвода, пусто для остальных
      {{squad-num}}   - номер взвода, пусто если не во взводе
      ...
      {{battletier}}  - угаданный уровень текущего боя
      + макросы статистики (см. ниже)

    Только в ушах, на экране загрузки боя, в окне статистики боя по Tab:
      {{frags}}       - текущие фраги
      {{alive}}       - 'alive' для живых, '' для мертвых

    Только в маркерах над танком:
